...
%\noindent\textbf{{\it When is fast convergence to a near optimal solution possible?}}
...
%\begin{comment}\begin{Theorem}\label{t:main theorem 1 ch1}
...
%----------------------------- Main Theorem -----------------------------%
\begin{Theorem}\label{t:main theorem 2 ch2}
